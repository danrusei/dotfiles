...
Plug 'machakann/vim-highlightedyank'      "highlight when yy
...
" 
" Instead of the below plugins use: coc-go, coc-python, coc-rust-analyzer 
"
...
" open automatcally if no file has been specified
